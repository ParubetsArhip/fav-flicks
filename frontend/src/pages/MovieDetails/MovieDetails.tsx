...
// // import { fetchMovieById, fetchMovieCredits, fetchMovieVideos } from "../lib/tmdb";
...
//     if (error) return <p className="text-center text-red-500">Failed to load movie.</p>;
...
//                     alt={movie.title}
//                     className="w-full md:w-[350px] rounded-2xl shadow-lg"
//                 />
...
//                             <div
//                                 key={actor.id}
//                                 className="min-w-[120px] bg-white/10 p-3 rounded-xl flex flex-col items-center text-center"
//                             >
//                                 {actor.profile_path ? (
//                                     <img
...
//                                     />
//                                 ) : (
//                                     <div className="w-[100px] h-[140px] bg-gray-700 rounded-lg mb-2 flex items-center justify-center">
//                                         No Image
//                                     </div>
//                                 )}
